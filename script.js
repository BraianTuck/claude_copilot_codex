...
const changelog = [
  ...
  { date: "2026-09-18", entries: [{ tool: "claude", title: "🎬 Which Claude model should you use?", body: "Picking the cheapest Claude model at the lowest effort looks like the obvious way to save money. With Claude Fable 5.1, a more intelligent model can cost less to complete a task. Learn what decides th...", url: "https://www.youtube.com/watch?v=71-8fJIGi34" }] },
  { date: "2026-09-17", entries: [{ tool: "claude", title: "🎬 Projects are now a conversation with Claude", body: "Projects in Claude used to be a folder of chats. Now a project is one conversation: you say what you need as it comes to you, and Claude picks up each request and reports back as it goes. A few quick ...", url: "https://www.youtube.com/watch?v=5qt_aGyAsKk" }] },
  { date: "2026-09-16", entries: [{ tool: "claude", title: "🎬 Meet Claude Slides, Claude Design and Claude Docs", body: "A deck, a set of social images and a field one-pager from one launch brief, without leaving the conversation. Claude Slides, Claude Design and Claude Docs are now in beta. Comment on anything and send...", url: "https://www.youtube.com/watch?v=To5nrYqvR44" }] },
  { date: "2026-09-16", entries: [{ tool: "claude", title: "🎬 Claude Cowork and chat are now one Claude", body: "You don't have to choose between chat and Claude Cowork anymore. Ask Claude a quick question or hand it a bigger task, and it brings in whatever the task needs. Meaghan Choi, who leads design for Clau...", url: "https://www.youtube.com/watch?v=qMUf-jwSpMo" }] },
  ...
  { date: "2026-09-01", entries: [{ tool: "claude", title: "🎬 Debugging across the whole stack with Claude Fable 5.1", body: "Claude Fable 5.1 is particularly strong on long-running engineering work, and it's smart enough to fix the root cause of an issue rather than the symptoms.  In this example, Fable 5.1 works through mo...", url: "https://www.youtube.com/watch?v=jwztQLH76is" }] },
  { date: "2026-09-01", entries: [{ tool: "claude", title: "🎬 Introducing Claude Fable 5.1", body: "Claude Fable 5.1 is the latest upgrade to our most capable class of models. It excels at complex, long-running tasks, and its research capabilities offer an early glimpse of how AI will contribute to ...", url: "https://www.youtube.com/watch?v=ROF2Nv_KjOM" }] },
  { date: "2026-08-28", entries: [{ tool: "claude", title: "🎬 Model Hardware Standard: AI operating physical equipment", body: "The Model Hardware Standard (MHS) is a new standard for AI agents to safely operate physical equipment in scientific research and advanced manufacturing.   MHS started as part of a beneficial deployme...", url: "https://www.youtube.com/watch?v=UxJZrCFzTHY" }] },
  { date: "2026-08-27", entries: [{ tool: "claude", title: "🎬 We're building a way for AI models to connect to any device and run real experiments.", body: "Scientists spend a significant amount of their time just getting their devices to communicate with one another. Each device tends to have its own programming interface, and so far there has been no st...", url: "https://www.youtube.com/watch?v=djVUCj5i4sw" }] },
  { date: "2026-08-26", entries: [{ tool: "claude", title: "🎬 Claude for Word: Turn a draft into a finished document", body: "See exactly how Claude works inside Microsoft Word. Reading a document, resolving reviewer comments, fact-checking claims, cutting length, and copy editing, all as tracked changes you approve along th...", url: "https://www.youtube.com/watch?v=x80HVKbZrno" }] },
  { date: "2026-08-19", entries: [{ tool: "claude", title: "🎬 How to choose the right Claude model for any task", body: "Choose a Claude model based on the complexity of the task. Then adjust the effort level to move between faster or more thorough results.", url: "https://www.youtube.com/watch?v=dgNQhaxVals" }] },
  { date: "2026-08-26", entries: [{ tool: "claude", title: "🎬 Claude for Word: Turn a draft into a finished document", body: "See exactly how Claude works inside Microsoft Word. Reading a document, resolving reviewer comments, fact-checking claims, cutting length, and copy editing, all as tracked changes you approve along th...", url: "https://www.youtube.com/watch?v=x80HVKbZrno" }] },
  { date: "2026-08-25", entries: [{ tool: "claude", title: "🎬 Claude for Word: Turn a draft into a finished document", body: "See exactly how Claude works inside Microsoft Word. Reading a document, resolving reviewer comments, fact-checking claims, cutting length, and copy editing, all as tracked changes you approve along th...", url: "https://www.youtube.com/watch?v=T8rIGSjnIzg" }] },
  { date: "2026-08-19", entries: [{ tool: "claude", title: "🎬 How to choose the right Claude model for any task", body: "Choose a Claude model based on the complexity of the task. Then adjust the effort level to move between faster or more thorough results.", url: "https://www.youtube.com/watch?v=dgNQhaxVals" }] },
  { date: "2026-08-14", entries: [{ tool: "claude", title: "🎬 What does AI actually know about you?", body: "The information you share with AI only travels as far as you let it. Zoe from the Anthropic education team explains what happens to your information when you chat with an AI, how long it stays there, ...", url: "https://www.youtube.com/watch?v=V12aLcjX23Q" }] },
  ...
  { date: "2026-08-08", entries: [{ tool: "claude", title: "🎬 What happens when you talk to AI?", body: "An AI model writes one word at a time, but it doesn't think one word at a time. Jane from Anthropic’s user experience team breaks down the prediction process behind every AI output, and how to better ...", url: "https://www.youtube.com/watch?v=RyjROxHLi_g" }] },
  { date: "2026-08-06", entries: [{ tool: "claude", title: "🎬 How Ramp engineers work with AI agents at every step", body: "Ramp runs AI agents across its entire engineering lifecycle: writing code, reviewing it, watching production, and root-causing incidents. Boris sat down with Austin Ray and Rahul Sengottuvelu of Ramp ...", url: "https://www.youtube.com/watch?v=i4odXOmgMLw" }] },
